...
- CALIB_HAND_EYE_TSAI：经典 Tsai-Lenz 算法，基于旋转对数最小二乘，最常用，鲁棒性一般，收敛快。
- CALIB_HAND_EYE_PARK：Park-Martin 算法，旋转先解，平移后解，相比 Tsai 更加精确。
- CALIB_HAND_EYE_HORAUD：Horaud 方法，闭式求解旋转，再解平移，  算法稳定性较好。
- CALIB_HAND_EYE_ANDREFF：  Andreff 算法，  较少使用。
- CALIB_HAND_EYE_DANIILIDIS：基于 dual-quaternion（双四元数）最小二乘，  精度高，对噪声敏感，可同时优化旋转和平移。
