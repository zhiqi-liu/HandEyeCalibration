...
class HandEyeCalib:
    ...
    def run_opencv_hand_to_eye(self, images_dir_, hand_angle_file_, degree_ = False):
        ...
        print("OpenCV residual:", self._SE3_residual(X_, T_base2ends, T_target2cams))
    ...
    def run_my_hand_to_eye(self, images_dir_, hand_angle_file_, degree_ = False):
        ...
        print("My residual1:", self._SE3_residual(X1_, T_base2ends, T_target2cams))

        X2_ = np.eye(4)
        X2_[0:3, 0:3] = R_cam2base2
        X2_[0:3, 3] = t_cam2base2.squeeze()
        print("My residual2:", self._SE3_residual(X2_, T_base2ends, T_target2cams))
